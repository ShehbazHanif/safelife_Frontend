...
export default {
  ...
  theme: {
    fontSize: {
      xs: ["12px", { lineHeight: "150%", fontWeight: "500" }],
      sm: ["14px", { lineHeight: "150%", fontWeight: "600" }],
      base: ["16px", { lineHeight: "150%", fontWeight: "600" }],
      xb: ["14px", { lineHeight: "150%", fontWeight: "500" }],
      xl: ["18px", { lineHeight: "150%", fontWeight: "600" }],
      lg: [
        "24px",
        {
          lineHeight: "150%",
